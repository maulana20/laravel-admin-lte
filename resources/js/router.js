...
const routes = [
	{ path: '/', name: 'home', component: require('./pages/welcome.vue').default, meta: { auth: true } },
	...
	{ path: '/admin/user', name: 'admin-user', component: require('./pages/user/index.vue').default, meta: { auth: true } },
	{ path: '/admin/role', name: 'admin-role', component: require('./pages/role/index.vue').default, meta: { auth: true } },
