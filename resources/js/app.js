...
Vue.component('header-template', require('./components/HeaderComponent.vue').default);
Vue.component('footer-template', require('./components/FooterComponent.vue').default);
